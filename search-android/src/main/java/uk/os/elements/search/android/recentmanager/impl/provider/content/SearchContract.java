...
public class SearchContract {
    ...
    private static String initAuthority() {
        String authority = "uk.os.elements.search";

        try {
            ClassLoader loader = SearchContract.class.getClassLoader();

            Class<?> clz = loader.loadClass("uk.os.elements.search.android.recentmanager.impl.provider.SearchContentProviderAuthority");
