...
import uk.os.elements.search.android.recentmanager.impl.provider.RecentsManagerImpl;
import uk.os.elements.search.android.util.RxUtil;
import uk.os.elements.search.android.util.ViewUtil;
